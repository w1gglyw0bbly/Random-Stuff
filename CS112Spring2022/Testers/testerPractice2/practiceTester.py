...
class AllTests (unittest.TestCase):
    ...
    ############################################################################
    def test_inchestoFtYards_1(self):
    	self.assertEqual(inchestoFtYards(200), 'That is: \n5 yards, 1 feet 8 inches.')

    def test_inchestoFtYards_2(self):
    	self.assertEqual(inchestoFtYards(100), 'That is: \n2 yards, 2 feet 4 inches.')

    def test_inchestoFtYards_3(self):
    	self.assertEqual(inchestoFtYards(2), 'That is: \n0 yards, 0 feet 2 inches.')

    def test_inchestoFtYards_4(self):
    	self.assertEqual(inchestoFtYards(1000), 'That is: \n27 yards, 2 feet 4 inches.')
    ############################################################################
