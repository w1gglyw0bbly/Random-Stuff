...
REQUIRED_DEFNS = [
                    "break_time", 'how_many_uruks', 'years_to_rule',
                    'lotr_popularity'
                 ]
...
class AllTests (unittest.TestCase):
    ...
    '''break_time tests -- x1 pts each == 10 pts'''

    def test_break_time_1(self):
        self.assertEqual(break_time(13, 2), 1)
    
    def test_break_time_2(self):
        self.assertEqual(break_time(13, 3), 3)
    
    def test_break_time_3(self):
        self.assertEqual(break_time(12, 2), 0)
    
    def test_break_time_4(self):
        self.assertEqual(break_time(65, 4), 1)
    
    def test_break_time_5(self):
        self.assertEqual(break_time(20, 3), 1)
    
    def test_break_time_6(self):
        self.assertEqual(break_time(20, 6), 2)
    
    def test_break_time_7(self):
        self.assertEqual(break_time(32, 3), 2)
    
    def test_break_time_8(self):
        self.assertEqual(break_time(0, 2), 0)
    
    def test_break_time_9(self):
        self.assertEqual(break_time(14, 1), 0)
    
    def test_break_time_10(self):
        self.assertEqual(break_time(100, 8), 3)
    

    ############################################################################

    '''how_many_uruks tests -- x1 pts each == 10 points'''

    def test_how_many_uruks_1(self):
        self.assertEqual(how_many_uruks([1, 2, 3, 4], 5), 3)
    
    def test_how_many_uruks_2(self):
        self.assertEqual(how_many_uruks([1, 2, 0, 3, 4], 5), 3)
    
    def test_how_many_uruks_3(self):
        self.assertEqual(how_many_uruks([1, 2, 0, 3, 4], 1), 5)
    
    def test_how_many_uruks_4(self):
        self.assertEqual(how_many_uruks([3, 3, 4, 11], 8), 3)
    
    def test_how_many_uruks_5(self):
        self.assertEqual(how_many_uruks([3, 3, 4, 9, 13], 8), 4)
    
    def test_how_many_uruks_6(self):
        self.assertEqual(how_many_uruks([3, 2, 2, 4], 10), 4)
    
    def test_how_many_uruks_7(self):
        self.assertEqual(how_many_uruks([3, 2, 2, 4, 15], 10), 5)
    
    def test_how_many_uruks_8(self):
        self.assertEqual(how_many_uruks([3, 2, 2, 4, 11], 10), 4)
    
    def test_how_many_uruks_9(self):
        self.assertEqual(how_many_uruks([3, 2, 2, 4, 13], 11), 4)
    
    def test_how_many_uruks_10(self):
        self.assertEqual(how_many_uruks([3, 2, 2, 4, 13], 9), 5)
	
	
	############################################################################

    '''years_to_rule tests -- x1 pts each == 10 points'''

    def test_years_to_rule_1(self):
        self.assertEqual(years_to_rule(4, 2, 3), 7)
    
    def test_years_to_rule_2(self):
        self.assertEqual(years_to_rule(5, 5, 5), 37)
    
    def test_years_to_rule_3(self):
        self.assertEqual(years_to_rule(5, 5, 1), 225)
    
    def test_years_to_rule_4(self):
        self.assertEqual(years_to_rule(1, 1, 1), 1)
    
    def test_years_to_rule_5(self):
        self.assertEqual(years_to_rule(3, 2, 3), 4)
    
    def test_years_to_rule_6(self):
        self.assertEqual(years_to_rule(5, 5, 2), 108)
    
    def test_years_to_rule_7(self):
        self.assertEqual(years_to_rule(5, 4, 2), 72)
    
    def test_years_to_rule_8(self):
        self.assertEqual(years_to_rule(4, 5, 2), 72)
    
    def test_years_to_rule_9(self):
        self.assertEqual(years_to_rule(4, 4, 2), 48)
    
    def test_years_to_rule_10(self):
        self.assertEqual(years_to_rule(4, 1, 2), 4)


    ############################################################################

    '''lotr_popularity tests -- 1x each == 10 points'''

    def test_lotr_popularity_1(self):
        self.assertEqual(lotr_popularity(["Gandalf", "Aragorn", "Arwen", "Legolas", "Sauron", "Aragorn", "Gandalf", "Aragorn"]), 'Most Appeared: Aragorn, Popularity: 85')
    
    def test_lotr_popularity_2(self):
        self.assertEqual(lotr_popularity(["Pippin", "Arwen", "Legolas", "Sauron", "Gollum"]), 'Most Appeared: Legolas, Popularity: 5')
        
    def test_lotr_popularity_3(self):
        self.assertEqual(lotr_popularity(["Gandalf", "Sam", "Gandalf"]), 'Most Appeared: Gandalf, Popularity: 20')
    
    def test_lotr_popularity_4(self):
        self.assertEqual(lotr_popularity(["Pippin", "Arwen", "Pippin", "Legolas", "Sauron", "Gollum"]), 'Most Appeared: Legolas, Popularity: 5')
    
    def test_lotr_popularity_5(self):
        self.assertEqual(lotr_popularity(["Aragorn"]), 'Most Appeared: Aragorn, Popularity: 20')
    
    def test_lotr_popularity_6(self):
        self.assertEqual(lotr_popularity(["Gimli", "Legolas", "Gandalf", "Legolas", "Aragorn", "Legolas", "Arwen", "Legolas", "Sauron", "Gandalf", "Aragorn"]), 'Most Appeared: Legolas, Popularity: 80')
    
    def test_lotr_popularity_7(self):
        self.assertEqual(lotr_popularity(["Gimli", "Legolas", "Legolas", "Aragorn", "Legolas", "Arwen", "Legolas", "Sauron", "Aragorn"]), 'Most Appeared: Legolas, Popularity: 60')
        
    def test_lotr_popularity_8(self):
        self.assertEqual(lotr_popularity(["Gimli", "Legolas", "Legolas", "Aragorn", "Legolas", "Arwen", "Sauron", "Aragorn"]), 'Most Appeared: Legolas, Popularity: 55')
        
    def test_lotr_popularity_9(self):
        self.assertEqual(lotr_popularity(["Gimli", "Legolas", "Gandalf", "Legolas", "Legolas", "Arwen", "Legolas", "Sauron", "Gandalf"]), 'Most Appeared: Legolas, Popularity: 40')
        
    def test_lotr_popularity_10(self):
        self.assertEqual(lotr_popularity(["Gandalf", "Aragorn", "Arwen", "Sauron", "Aragorn", "Gandalf", "Aragorn"]), 'Most Appeared: Aragorn, Popularity: 80')
