...
REQUIRED_DEFNS = [
                    "robot_actions", "bad_broker", "spectral_color"
                 ]
...
class AllTests (unittest.TestCase):
    ...
    '''spectral_color tests -- x2 pts each == 18 pts '''

    def test_spectral_color_1(self):
    	self.assertEqual(spectral_color(550), "green")

    def test_spectral_color_2(self):
    	self.assertEqual(spectral_color(590), "orange")

    def test_spectral_color_3(self):
    	self.assertEqual(spectral_color(999), "infrared")

    def test_spectral_color_4(self):
    	self.assertEqual(spectral_color(200), "ultraviolet")

    def test_spectral_color_5(self):
    	self.assertEqual(spectral_color(490), "cyan")

    def test_spectral_color_6(self):
    	self.assertEqual(spectral_color(450), "blue")

    def test_spectral_color_7(self):
    	self.assertEqual(spectral_color(395), "violet")

    def test_spectral_color_8(self):
    	self.assertEqual(spectral_color(589), "yellow")

    def test_spectral_color_9(self):
    	self.assertEqual(spectral_color(625), "red")

    ############################################################################


    '''bad_broker tests -- x2 pts each == 6 pts'''

    def test_bad_broker_1(self):
    	self.assertEqual(bad_broker(15,17.5), "SELL")

    def test_bad_broker_2(self):
    	self.assertEqual(bad_broker(300,150), "BUY")

    def test_bad_broker_3(self):
    	self.assertEqual(bad_broker(0.99,1000), "HOLD")


    ############################################################################

    '''robot_action tests -- x2 pts each == 16 pts'''

    def test_robot_actions_1(self):
    	self.assertEqual(robot_actions('wall','wall','dirt'), 'vacuum')

    def test_robot_actions_2(self):
    	self.assertEqual(robot_actions('wall','clear','dirt'), 'vacuum')

    def test_robot_actions_3(self):
    	self.assertEqual(robot_actions('clear','wall','dirt'), 'vacuum')

    def test_robot_actions_4(self):
    	self.assertEqual(robot_actions('clear','clear','dirt'), 'vacuum')

    def test_robot_actions_5(self):
    	self.assertEqual(robot_actions('wall','wall','clear'), 'turn')

    def test_robot_actions_6(self):
    	self.assertEqual(robot_actions('wall','clear','clear'), 'forward')

    def test_robot_actions_7(self):
    	self.assertEqual(robot_actions('clear','wall','clear'), 'turn')

    def test_robot_actions_8(self):
    	self.assertEqual(robot_actions('clear','clear','clear'), 'stop')
