...
REQUIRED_DEFNS = [
                    'biggest_vertebrate', 'within_weight', 'any_adjacent_vertebrates',
                    'count_weights'
                 ]
...
class AllTests (unittest.TestCase):
    ...
    ############################################################################
	def test_count_weights_1  (self):self.assertEqual(count_weights([1,2,3,4,5]), 4)
	def test_count_weights_2  (self):self.assertEqual(count_weights([1,2,3,1,0]), 7)
	def test_count_weights_3  (self):self.assertEqual(count_weights([3,1,2]), 1)
	def test_count_weights_4  (self):self.assertEqual(count_weights([3,13,4,5]), 0)
	def test_count_weights_5  (self):self.assertEqual(count_weights([0,0,0,0]), 6)
	def test_count_weights_6  (self):self.assertEqual(count_weights([1,2,3,5,7,11,13,17,19,23]), 5)
	def test_count_weights_7  (self):self.assertEqual(count_weights([1,2,2,3,5,7,11,13,17,19,23]), 10)

	def test_biggest_vertebrate_1(self): self.assertEqual(biggest_vertebrate(["a","b","c"],[5,9,6],["a","b","c"]),"b")
	def test_biggest_vertebrate_2(self): self.assertEqual(biggest_vertebrate(["aa"],[1],["aa"]),"aa")
	def test_biggest_vertebrate_3(self): self.assertEqual(biggest_vertebrate(['a','b','c'],[5,5,5],[]),None)
	def test_biggest_vertebrate_4(self): self.assertEqual(biggest_vertebrate(["a","b","c"],[3,4,5],["x","y","a"]),"a")
	def test_biggest_vertebrate_5(self): 
		animals = ["butterfly", "fly", "whale", "parrot"]
		weights = [.0005, .000007, 300000, 3.52]
		vertebrates = ["hamster", "crocodile", "parrot", "whale"]   
		self.assertEqual(biggest_vertebrate(animals, weights, vertebrates), "whale")
	def test_biggest_vertebrate_6(self): 
		animals = ["butterfly", "fly"]
		weights = [.0005, .000007]
		vertebrates = ["hamster", "human", "mouse"]
		self.assertEqual(biggest_vertebrate(animals, weights, vertebrates), None)
	def test_biggest_vertebrate_7(self): self.assertEqual(biggest_vertebrate([],[],["human"]), None)

	
	def test_within_weight_1(self): self.assertEqual(within_weight(["a","b","c","d"],[1,5,10,15],10),["a","b","c"])
	def test_within_weight_2(self): self.assertEqual(within_weight(['a','b','c'],[7,8,9],5),[])
	def test_within_weight_3(self): self.assertEqual(within_weight(['x','y','z'],[5,5,5],5),['x','y','z'])
	def test_within_weight_4(self): self.assertEqual(within_weight(['a'],[10],15),['a'])
	def test_within_weight_5(self): self.assertEqual(within_weight([],[],20),[])
	def test_within_weight_6(self): self.assertEqual(within_weight(['q','w','e','r','t','y'],[2,2,1,1,3,3],2),['q','w','e','r'])
	def test_within_weight_7(self): self.assertEqual(within_weight(['q','w','e','r','t','y'],[2,2,1,1,3,3],1),['e','r'])
	def test_within_weight_8(self):
		animals = ["butterfly", "whale", "parrot", "mouse", "cat"]
		weights = [.0005, 300000, 3.52, .05, 13]
		self.assertEqual(within_weight(animals, weights, 1),['butterfly','mouse'])
	def test_within_weight_9(self):
		animals = ["parrot", "mouse", "cat", "dog", "dolphin", "raccoon"]
		weights = [3.52, .05, 13, 60, 400, 25]
		self.assertEqual(within_weight(animals, weights, 13),['parrot','mouse', 'cat'])
	def test_within_weight_10(self):
		self.assertEqual(within_weight(["whale", "dolphin"], [300000, 400], 10),[])
	def test_within_weight_11(self):
		self.assertEqual(within_weight([], [], 5),[])

	def test_any_adjacent_vertebrates_1(self): self.assertEqual(any_adjacent_vertebrates(['a','b','c'],['a','b','d']),True)
	def test_any_adjacent_vertebrates_2(self): self.assertEqual(any_adjacent_vertebrates(['a','b','c'],['c','b']),True)
	def test_any_adjacent_vertebrates_3(self): self.assertEqual(any_adjacent_vertebrates(['a','b','c'],['a','c']),False)
	def test_any_adjacent_vertebrates_4(self): self.assertEqual(any_adjacent_vertebrates(['a','b','a'],['c','a']),False)
	def test_any_adjacent_vertebrates_5(self): self.assertEqual(any_adjacent_vertebrates([],['a','b','c']),False)
	def test_any_adjacent_vertebrates_6(self): self.assertEqual(any_adjacent_vertebrates(['a','b','c','d','e'],['d','b','e']),True)
	def test_any_adjacent_vertebrates_7(self): self.assertEqual(any_adjacent_vertebrates(['a','b','c','d','e'],['x','y','z']),False)
	def test_any_adjacent_vertebrates_8(self): self.assertEqual(any_adjacent_vertebrates(['AA','AAA'],['AAA','C','D','AA']),True)
	def test_any_adjacent_vertebrates_9(self): 
		animals = ["butterfly", "fly", "whale", "parrot"] 
		vertebrates = ["hamster", "crocodile", "parrot", "whale"] 
		self.assertEqual(any_adjacent_vertebrates(animals, vertebrates),True)
	def test_any_adjacent_vertebrates_10(self): 
		animals = ["human", "fly", "hamster"]
		vertebrates = ["hamster", "human", "mouse"]
		self.assertEqual(any_adjacent_vertebrates(animals, vertebrates),False)
	def test_any_adjacent_vertebrates_11(self): 
		animals = ["human", "fly", "starfish", "octopus", "spider", "mouse", "deer"] 
		vertebrates = ["human", "deer", "whale", "mouse"]
		self.assertEqual(any_adjacent_vertebrates(animals, vertebrates),True)
